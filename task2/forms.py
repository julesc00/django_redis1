...
class ReviewForm(forms.Form):
    name = forms.CharField(label="Firstname", min_length=4, max_length=50, widget=forms.TextInput(attrs={
    ...
    def send_email(self):
        send_review_email_task.delay(self.cleaned_data["name"], self.cleaned_data["email"],
